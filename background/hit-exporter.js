...
function plainTemplate(hit) {
  return new Promise(async resolve => {
    ...
    Requester: ${requester_name}
      Title: ${title} 
      Preview: https://worker.mturk.com/projects/${hit_set_id}/tasks 
      Accept: https://worker.mturk.com/projects/${hit_set_id}/tasks/accept_random
      Reward: ${reward}
      Available: ${assignable_hits_count}
      Qualifications: ${qualifications}
      GID: ${hit_set_id}
      OW: ${requester_id}@${requester_name}
      ---------------------------------------------- Get That Money!!!----------------------------------------------------`;
